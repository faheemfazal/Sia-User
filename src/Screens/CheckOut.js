...
/>
  ...
  ₹ {cartViews?.reduce((acc, item) => acc + item.total, 0).toFixed(2)}
                  ...
                  <button
        type="submit"
        className="rounded-full px-4 py-2 mb-4 flex gap-2 text-[#63247d] hover:text-white hover:bg-[#63247d] font-bold text-xl border-2 border-[#63247d] whitespace-nowrap"
